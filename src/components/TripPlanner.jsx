...
// Simple default values so the form works out of the box
const defaultForm = {
  origin: "",
  destination: "",
  startDate: "",
...
export default function TripPlanner() {
  ...
  // shape that Itinerary expects:
  const [itinerary, setItinerary] = useState(null);
  // { tripTitle, days: [{title,location,bullets[]}], budgetRows: [...] }
  ...
  async function handleGenerate(e) {
    ...
    try {
      ...
      // Normalize → Itinerary component shape
  ...
  return (
    <div className="space-y-4">
      <Card>
        <CardHeader>
          <CardTitle className="text-lg font-bold">Plan Your Trip</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      {itinerary && (
        <>
          ...
          <div className="flex gap-2">
            ...
            {/* PDF export can be added next; keeping it simple for now */}
          </div>
        </>
      )}
    </div>
