  ...
  return (
    <div className="bg-[#F9F9F9] text-[#333333] min-h-screen">
      ...
      <section className="text-center py-24 px-4 bg-white">
        <h1 className="text-3xl md:text-4xl font-bold text-[#1F2F46]">Plan Smarter. Travel Better.</h1>
        <p className="mt-4 text-base md:text-lg text-[#333] max-w-xl mx-auto">Your AI-powered travel assistant for China and beyond — build itineraries, estimate time and budget, and simplify complex travel planning.</p>
        <div className="mt-6">
      ...
      <section id="features" className="py-20 px-4 max-w-6xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold text-center text-[#1F2F46] mb-12">Core Features</h2>
      ...
      <section id="signup" className="bg-[#3EC1D3] py-16 text-white text-center px-4">
      ...
      <footer className="bg-[#1F2F46] text-white text-center p-6 text-sm">
